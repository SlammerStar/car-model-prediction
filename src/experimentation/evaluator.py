...
class ModelEvaluator:
    ...
    def evaluate_pipeline(self, pipeline, X_train: pd.DataFrame, y_train: pd.Series, X_test: pd.DataFrame, y_test: pd.Series) -> Dict[str, Any]:
        """
    ...
    def cross_validate_pipeline(self, pipeline, X: pd.DataFrame, y: pd.Series) -> Dict[str, float]:
        """
